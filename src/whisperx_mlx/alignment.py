"""
Forced Alignment with Whisper - adapted from WhisperX
Original author: C. Max Bain

This module provides word-level alignment using wav2vec2 models.
"""
import math
...
from whisperx_mlx.audio import SAMPLE_RATE, load_audio
from whisperx_mlx.schema import (
...
def align(
    ...
    Args:
        transcript: List of transcription segments with text and timestamps
        model: Alignment model (from load_align_model)
        align_model_metadata: Model metadata including dictionary
        audio: Audio data (path, numpy array, or tensor)
        device: Device for computation
        interpolate_method: Method for interpolating timestamps
        return_char_alignments: Whether to include character-level alignments
        print_progress: Whether to print progress
        combined_progress: Whether progress is combined with transcription
...
# CTC alignment functions from PyTorch tutorial
